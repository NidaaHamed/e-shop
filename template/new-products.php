...
?>
      ...
      <section id="new-products">
          <div class="container">
            <h4 class="font-amiri font-size-20">New Products</h4>
            <hr>
            <div class="owl-carousel owl-theme">
              ...
              <div class="item py-2">
                <div class="product font-reemkufi">
                  <a href="product.php?id=<?php echo $row['pro_id']?>"> <img src="./images/<?php echo $row['img'];?>" alt="product" class="img-fluid px-2" style="height: 200px;"> </a>
